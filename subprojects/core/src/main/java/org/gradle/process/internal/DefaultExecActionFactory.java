...
public abstract class DefaultExecActionFactory implements ExecFactory {
    ...
    private static class BuilderImpl implements Builder {
        ...
        @Override
        public Builder withExternalProcessStartedListener(ExternalProcessStartedListener externalProcessStartedListener) {
    ...
    private static class DecoratingExecActionFactory extends DefaultExecActionFactory {
        ...
        @Nullable
        private ExecHandleListener cachedExecHandleListener;
        ...
        private ExecHandleListener getExecHandleListener() {
            if (cachedExecHandleListener == null && externalProcessStartedListener != null) {
                cachedExecHandleListener = new ExecHandleListener() {
                    @Override
            ...
            return cachedExecHandleListener;
        }
    }
